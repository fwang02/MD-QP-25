...
data <- data %>%
  mutate(Previous.qualification = case_when(
    Previous.qualification %in% c("12th year of schooling - not completed", 
                                  "11th year of schooling - not completed", 
                                  "Basic education 3rd cycle (9th/10th/11th year) or equiv.", 
                                  "Basic education 2nd cycle (6th/7th/8th year) or equiv.",
                                  "10th year of schooling",
                                  "10th year of schooling - not completed", 
                                  "Other - 11th year of schooling") ~ "Basic Education",
    
    Previous.qualification == "Secondary education" ~ "Secondary Education",
    
    Previous.qualification %in% c("Higher education - bachelor's degree", 
                                  "Higher education - degree", 
                                  "Frequency of higher education",
                                  "Higher education - degree (1st cycle)") ~ "Higher Education (Undergraduate)",
    
    Previous.qualification %in% c("Higher education - master's", 
                                  "Higher education - doctorate", 
                                  "Higher education - master (2nd cycle)") ~ "Higher Education (Postgraduate)",
    
    Previous.qualification %in% c("Technological specialization course", 
                                  "Professional higher technical course") ~ "Technological & Professional Courses",
