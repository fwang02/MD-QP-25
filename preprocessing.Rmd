...
data <- data %>%
  mutate(
    percent_approved_1st_sem = ifelse(percent_approved_1st_sem > 1, 1, percent_approved_1st_sem),
    percent_approved_2nd_sem = ifelse(percent_approved_2nd_sem > 1, 1, percent_approved_2nd_sem)
  )
...
data <- data %>%
  mutate(Course = case_when(
    Course == "Nursing" ~ "Health Sci",
    Course == "Veterinary Nursing" ~ "Health Sci",
    Course == "Oral Hygiene" ~ "Health Sci",
    Course == "Social Service" ~ "Health Sci",
    Course == "Social Service (evening attendance)" ~ "Health Sci",
    Course == "Management" ~ "Business & Mgmt",
    Course == "Management (evening attendance)" ~ "Business & Mgmt",
    Course == "Advertising and Marketing Management" ~ "Business & Mgmt",
    Course == "Journalism and Communication" ~ "Business & Mgmt",
    Course == "Informatics Engineering" ~ "Tech & Eng",
    Course == "Biofuel Production Technologies" ~ "Tech & Eng",
    Course == "Animation and Multimedia Design" ~ "Design & Media",
    Course == "Communication Design" ~ "Design & Media",
    Course == "Agronomy" ~ "Agri & Env",
    Course == "Equinculture" ~ "Agri & Env",
    Course == "Basic Education" ~ "Edu & SocSci",
    Course == "Tourism" ~ "Edu & SocSci",
